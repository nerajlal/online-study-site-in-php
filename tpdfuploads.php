...
<a href="delete.php?key=<?php echo $r['id']?>">Delete</a>
 <!-- <a href="delete.php?id=<?php echo $r['file']?>"><input type='submit' name='submit' value='Delete' class="btn btn-danger"></input></a> -->
