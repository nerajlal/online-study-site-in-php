<?php /* Smarty version 2.6.26, created on 2023-02-19 07:16:15
         compiled from adminhospitalview.tpl */ ?>
<!DOCTYPE html>
<html lang="en">
   <head>
      <!-- basic -->
...
?>
                                          <tr>
                                             ...
                                             <td><a href="hospitalapprove.php?a=<?php echo $this->_tpl_vars['d']['loginid']; ?>
" class="btn btn-success">approve</a></td>
                                             <td><a href="hospitalreject.php?r=<?php echo $this->_tpl_vars['d']['loginid']; ?>
