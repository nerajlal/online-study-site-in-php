...
{
    $sql = "UPDATE `login` SET plan_status = '1' WHERE lid = $lid";
    if(mysql_query($sql,$conn))
        echo "<script>alert('Plan Updated!');location.href='uclass.php';</script>";
    else
        echo "<script>alert('Error!');location.href='upgrade.php';</script>";
}
else 
    //echo "Sorry";
?>