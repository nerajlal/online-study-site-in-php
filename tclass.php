...
<center><br><br>
    <b><u><h1 style="color: white">Upload Video</h1></u></b><br>
...
if(isset($_POST["submit"])){
 ...
 $name=$_POST['name'];
    $q="INSERT into tutor(tutor_id,type,topic,file) values('11','vedio','$name','$target_file')";
     echo $q;
    if(mysql_query($q,$conn))
    {
        echo "<script>alert('Vedio Added!');
                            location.href='tclass.php';
                    </script>";

    }
    else{
         echo "<script>alert('Vedio Can't Add!');
                            location.href='tclass.php';
                    </script>";
    }
